...
class Tile:
    ...
    Provides the default tile behaviour. Can be inhereted or overwritten by
    specific types of tiles.

    Args:
        _type_ (_type_): A tile object
        can_move (bool): A boolean representing whether the tile is blocking or
        not.

        type (str): A string representing the type of the tile
        
    Attributes:
        _type (str): A string representing the type of the tile.
        _is_blocking (bool): A boolean representing whether the tile is blocking
    ...
    Methods:
        ...
        is_blocking(self) -> bool:
            Returns True if the tile is blocking, False otherwise.
        get_type(self) -> str:
    ...
    def __init__(self) -> None:
        """__init__: Initialize a Tile object.

        Initialises the tile as non-blocking and with the type 'Abstract Tile'.
        """
    ...
    def get_type(self) -> str:
        ...
        For the abstract Tile class, this method returns the string
        'Abstract Tile'.
        ...
        Args:
            _type_ (_type_): A tile object
            can_move (bool): A boolean representing whether the tile is blocking 
            or not.

            type (str): A string representing the type of the tile

        Returns:
            str: A string representing the type of the tile.
        """
...
class Floor(Tile):
    ...
    Entities can freely move on this space, is non-blocking and is 
    ...
    Examples:
        ...
        >>> str(floor)
        ' '
        >>> floor # This is a string displaying without quotation marks
...
class Goal(Tile):
    ...
    Args:
        Tile (_type_): A tile object
        can_move (bool): A boolean representing whether the tile 
        is blocking or not
        type (str): A string representing the type of the tile
        
    Attributes:
        _type (str): A string representing the type of the tile.
        _filled (bool): A boolean representing whether the goal is filled.
    ...
    Methods:
        ...
        get_type(self) -> str:
            Returns the type of the tile.
        is_filled(self) -> bool:
            Returns True if the goal is filled, False otherwise.
        fill(self) -> None:
            Fills the goal.
        __str__(self) -> str:
            Returns a string representation of the tile.
...
class Entity:
    ...
    Attributes:
        _type (str): A string representing the type of the entity.
        _tile (Tile): A tile object, returns None if no tile is present
    ...
    Examples:
        ...
        >>> str(entity)
        'Abstract Entity'
        >>> entity # Note that this is a string 
        displaying without quotation marks
        Abstract Entity
    ...
    def get_type(self) -> str:
        ...
        For the abstract Entity class, this method returns the string 
        'Abstract Entity'. For instantiable subclasses, this method should 
        return the single letter constant corresponding to the class.
        """
        return self._type
    ...
    def __str__(self) -> str:
        """Return a string representation of the entity. In most cases, 
...
class Crate(Entity):
    ...
    Crates have a strength value, which represents the strength the player needs
    to push the crate. The string representation of a crate should be the string
    version of its strength value. Strength of the crate will always be between 
    0 and 9, inclusive.

    Blocking players from moving crates that they are not strong enough to move
    should not be handled here. A crate only needs to be aware of its own 
    strength, and provide interface for which the model class 
    can access the information.

    Args:
        Entity (_type_): Entity is a parent class of Crate
        
    Attributes:
        _type (str): A string representing the type of the entity.
        _strength (int): An integer representing the strength of the crate.
    ...
    Examples:
        ...
        >>> str(crate)
        '4'
        >>> crate # Note that this is a string 
        displaying without quotation marks
        4
    ...
    Methods:
        __init__(self, strength) -> None:
            Initializes a new instance of the Crate class.
        get_type(self) -> str:
            Returns the type of the entity.
        is_movable(self) -> bool:
            Returns True if the entity is movable, False otherwise.
        get_strength(self) -> int:
            Returns the strength of the crate.
        __str__(self) -> str:
            Returns the string representation of the crate.
        __repr__(self) -> str:
            Returns the string representation of the crate.
    """
...
class Potion(Entity):
    """An abstract class from which all instantiable types of 
    potions must implement.

    The __init__ methods for this class do not take any arguments except 'self'.
    Since this class inherits from Entity, it (along with subclasses) 
    should also provide all methods and attributes from Entity.

    Potions are not moveable.
    An abstract potion is represented by 'Potion' and has no effect.

    Args:
        Entity (_type_): Entity is a parent class of Potion 
        
    Attributes:
        _type (str): A string representing the type of the potion.
        _effect (dict[str, int]): A dictionary mapping the effect of the 
        potion to the amount of the effect.
    ...
    Examples:
        ...
        >>> str(potion)
        'Potion'
        >>> potion # Note that this is a string 
        displaying without quotation marks
        Potion
    ...
    Methods:
        ...
        is_movable(self) -> bool:
            Returns True if the potion is movable, False otherwise.
        effect(self) -> dict[str, int]:
            Returns the effect of the potion.
        __str__(self) -> str:
            Returns the string representation of the potion.
        __repr__(self) -> str:
            Returns the string representation of the potion.
    """
...
class StrengthPotion(Potion):
    ...
    Examples:
        ...
        >>> str(strength_potion)
        'S'
        >>> strength_potion # Note that this is a string 
        displaying without quotation marks
        S

    Methods:
        __init__(self) -> None:
            Initializes a new instance of the StrengthPotion class.
        get_type(self) -> str:
            Returns the type of the potion.
        is_movable(self) -> bool:
            Returns True if the potion is movable, False otherwise.
...
class MovePotion(Potion):
    ...
    Examples:
        ...
        >>> str(move_potion)
        'M'
        >>> move_potion # Note that this is a string 
        displaying without quotation marks
        M

    Methods:
        __init__(self) -> None:
            Initializes a new instance of the MovePotion class.
        get_type(self) -> str:
            Returns the type of the potion.
        is_movable(self) -> bool:
            Returns True if the potion is movable, False otherwise.
...
class FancyPotion(Potion):
    ...
    Examples:
        ...
        >>> str(fancy_potion)
        'F'
        >>> fancy_potion # Note that this is a string 
        displaying without quotation marks
        F

    Methods:
        __init__(self) -> None:
            Initializes a new instance of the FancyPotion class.
        get_type(self) -> str:
            Returns the type of the potion.
        is_movable(self) -> bool:
            Returns True if the potion is movable, False otherwise.
...
class Player(Entity):
    ...
    A player instance is constructed with a starting strength and initial number
    of moves. The player's strength and moves can be increased by collecting
    potions. A player is only moveable if they have a positive number of moves.

    Args:
        Entity (_type_): Entity is a parent class of Player
        type (str): A string representing the type of the entity.
        start_strength (int): An integer representing the starting strength of
        the player.
        moves_remaining (int): An integer representing the number of moves the
        player has remaining.
        
    Attributes:
        _type (str): A string representing the type of the entity.
        _start_strength (int): An integer representing the starting strength of
        the player.
        _start_moves (int): An integer representing the number of moves the
        player has remaining.
    ...
    Examples:
        ...
        >>> str(player)
        'P'
        >>> player # Note that this is a string 
        displaying without quotation marks
        P
    ...
    Methods:
        __init__(self, start_strength, moves_remaining) -> None:
        ...
        add_strength(self, amount) -> None:
            Adds strength to the player.
        get_moves_remaining(self) -> int:
            Returns the moves remaining of the player.
        add_moves_remaining(self, amount) -> None:
            Adds moves to the player.
        apply_effect(self, potion_effect) -> None:
            Applies the effect of a potion to the player.
    """

    def __init__(self, start_strength: int, moves_remaining: int) -> None:
        """
        Initializes a new instance of MyClass with the given start 
        strength and moves remaining.

        Args:
            start_strength (int): The starting strength of the instance.
...
def convert_maze(game: list[list[str]]) -> tuple[Grid, Entities, Position]:
    ...
    The read_file in a2_support will return a tuple containing a representation
    of the maze (including tiles and entities), and the player stats (strength
    and moves).

    The representation of the maze is in the format list[list[str]], where each
    string is a character representing a tile or entity at that position.

    If entity is present at a position, it is assumed that the tile underneath
    is a floor tile.

    1. A list of lists of Tile instances, representing the tiles on the grid.
    2. A dictionary mapping (row, column) positions to Entity instances. This
    dictionary only contains positions on which entities exist, and does not
    contain the player, despite the player being an entity.
    ...
    Examples:
        ...
        (1, 1)
    """
    # Instantiate all the tiles and entities 
    W, F = Wall(), Floor()
...
class SokobanModel:
    ...
    Attributes:
        ...
        _entities (Entities): A dictionary mapping the positions of entities in
            the maze to their respective objects.
        _player_position (tuple[int, int]): A tuple representing the position of
            the player in the maze.
        _player (Player): An object representing the player in the game.
        _moves (int): An integer representing the number of moves the player has
            made.
        _strength (int): An integer representing the strength of the player.
        _potion (int): An integer representing the number of potions the player
            has.
        ...
        _goal_position (list[tuple[int, int]]): A list of tuples representing
            the positions of the goals in the maze.
        _crate_position (list[tuple[int, int]]): A list of tuples representing
            the positions of the crates in the maze.
        _potion_position (list[tuple[int, int]]): A list of tuples representing
            the positions of the potions in the maze.
    ...
    Methods:
        __init__(self, maze_file) -> None:
            Initializes a new instance of the SokobanModel class.
        get_maze(self) -> Grid:
            Returns the maze.
        get_entities(self) -> Entities:
            Returns the entities.
        get_player_position(self) -> tuple[int, int]:
            Returns the player position.
        get_player_moves_remaining(self) -> int:
            Returns the player moves remaining.
        get_player_strength(self) -> int:
            Returns the player strength.
        find_goal_positions(self) -> None:
            Finds the positions of all goal cells in the maze and 
            stores them in the _goal_position dictionary.
        check_goals_filled(self) -> bool:
            Checks if all goals are filled with crates.
        attempt_move(self, direction) -> bool:
    ...
    def __init__(self, maze_file: str) -> None:
        ...
        Should read the given maze file, call convert_maze function to get the
        grid, entities, and player position, and initialize the player object.
        ...
        self._maze, self._entities, self._player_position = \
            convert_maze(read_file(maze_file)[0])
        self._player = Player(read_file(maze_file)[1][0], \
            read_file(maze_file)[1][1])
        self._moves = 0
        self._strength = 0
        self._potion = 0
        self._crate = 0
    ...
    def get_entities(self) -> Entities:
        ...
        Returns:
            Entities: A dictonary mapping the positions of entities 
            in the maze to their respective objects.
        """
    ...
    def get_player_position(self) -> tuple[int, int]:
        ...
        Returns:
            tuple[int, int]: A tuple representing the position of the 
            player in the maze.
        """
    ...
    def get_player_moves_remaining(self) -> int:
        ...
        Returns:
            int: An integer representing the number of moves the player 
            has remaining.
        """
    ...
    def find_goal_positions(self) -> None:
            """
            Finds the positions of all goal cells in the maze and 
            stores them in the _goal_position dictionary.
            ...
            for i, row in enumerate(self._maze):
                for j, cell in enumerate(row):
                    if cell.get_type() == GOAL:
                        self._goal_position[(i, j)] = cell

    def check_goals_filled(self) -> bool:
        """Checks if all goals are filled with crates.
        ...
        for goal in self._goal_position:
            if not self._goal_position[goal].is_filled():
                return False
        return True
    ...
    def attempt_move(self, direction: str) -> bool:
        ...
        Tries to move the player in the given direction if possible. 
        Any flow on effects from that move. (e.g. pushing a crate) 
        should be handled here. The method should return True if a 
        move occurred successfully, and False otherwise.

        The move has to be executed in this order:

        1. If the direction is not a valid move direction, 
        or the position would be out of bounds or blocked, return False.

        2. If the move would cause the player to move to a crate, 
        check if the crate can be pushed. If the crate can be pushed, 
        move the crate and the player. If the crate cannot be pushed, 
        return False. The moved crate would also have to be contained in 
        bounds of the maze, or this returns False.

        3. If the move would cause the player to move to a potion, 
        apply the effect of the player and remove the potion from the maze.

        4. If the move is valid, then update the player position and 
        decrease the player's moves remaining by 1. Return True.

        Args:
            direction (str): A string representing the direction to move in.

        Returns:
            bool: True if the move occurred successfully, False otherwise.
        ...
        # Get goal positions of the maze
        self.find_goal_positions()
        ...
        # Player position if moved in the given direction
        ...
        # Crate position if moved in the given direction
        ...
        # Check if the new position is out of bounds or blocked
        if not (
            ...
            # Check for Crates
                ...
                if crate_strength > self.get_player_strength():
                    ...
                    if not self._maze[new_crate_position_x][
                        ...
                        del entities[(new_position_x, new_position_y)]
                        entities[(new_crate_position_x, new_crate_position_y)]=\
                            Crate(crate_strength)
                        self._player_position = (new_position_x, new_position_y)
                        self._player.add_moves_remaining(-1)
                    else:
                        return False
                    ...
                    if (
                        ...
                        # Fill goal (Too long so I split it up)
                        self._maze[new_crate_position_x]\
                            [new_crate_position_y].fill()
                        del entities\
...
class Sokoban:
    ...
    Responsible for instantiating the model and view class. 
    Also handles events such as user input and communication 
    between the model and view.

    Attributes:
        _model (SokobanModel): An object representing the model class.
        _view (SokobanView): An object representing the view class.
    ...
    Methods:
        __init__(self, maze_file) -> None:
            Initializes a new instance of the Sokoban class.
        display(self) -> None:
            Generates the game state by calling the model's get_maze, 
            get_entities, and get_player_position methods, and passes 
            them to the view's display_game method.
        play_game(self) -> None:
            Runs the main loop and follows this behaviour:
            While the game is still going, repeat the following procedure:
            1. If the game has been won, display the game state and the message 
            'You won!', and return.
            2. If the game has been lost, display the message 'You lost!', 
            and return.
            3. Display the game state.
            4. Prompt the user for input 'Enter move: '.
            5. If the move is 'q', return, otherwise attempt to move the player 
    ...
    def __init__(self, maze_file: str) -> None:
        ...
        Should initialize the model and view classes, and call the view's
        draw method.
    ...
    def display(self) -> None:
        """display Generates the game state and displays it.

        Generates the game state by calling the model's get_maze, get_entities,
        and get_player_position methods, and passes them to the view's
        display_game method.
...
def main():
    ...
    This main function instantiates a Sokoban object and calls its play_game
    method.
